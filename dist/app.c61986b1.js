...
exports.setClock = void 0;

function setClock() {
  return _setClock.apply(this, arguments);
}

function _setClock() {
  _setClock = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var clock, date, dateString, timeString;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            clock = document.getElementById("clockHolder");
            date = new Date();
            dateString = date.toDateString();
            timeString = date.toLocaleTimeString();
            clock.innerText = "".concat(dateString, " ").concat(timeString);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            keyPress = event.code.replace("Digit", "");
            ...
            return _context2.delegateYield( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var current, target, timeIntervals;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      targetDisplay = "".concat(numDisplay1).concat(numDisplay2).concat(numDisplay3);
                      displayPageNumber(targetDisplay, targetHolder);
                      current = Number(currentDisplay);
                      target = Number(targetDisplay);
                      timeIntervals = getRandomTimeIntervals({
                        smallCount: 100,
                        smallValue: 10,
                        largeCount: 5,
                        largeValue: 250
                    ...
                    case 7:
                      ...
                      return new Promise(function (resolve) {
                        return setTimeout(resolve, timeIntervals[Math.floor(Math.random() * timeIntervals.length)]);
                      });
                    ...
                    case 15:
                      if (current === target) {
                        displayPageNumber("".concat(numDisplay1).concat(numDisplay2).concat(numDisplay3), counterHolder);
          ...
          case 5:
            if (numDisplay1 && !numDisplay2 && !numDisplay3) {
              ...
              displayPageNumber("-".concat(numDisplay1).concat(numDisplay2), targetHolder);
            }

            if (!numDisplay1 && !numDisplay2 && !numDisplay3) {
              numDisplay1 = keyPress;
              displayPageNumber("--".concat(numDisplay1), targetHolder);
            }
...
function displayPageNumber(data, elem) {
  elem.innerText = "".concat(data);
}

function displayContent(data) {
  var page = content_1.content.find(function (page) {
    return page["id"] === Number(data);
  });
...
function getRandomTimeIntervals(_ref2) {
  var smallCount = _ref2.smallCount,
      smallValue = _ref2.smallValue,
      largeCount = _ref2.largeCount,
      largeValue = _ref2.largeValue;
  var output = [];

  for (var _i = 0, _arr = _toConsumableArray(Array(smallCount).keys()); _i < _arr.length; _i++) {
    var elem = _arr[_i];
    output.push(smallValue);
  }

  for (var _i2 = 0, _arr2 = _toConsumableArray(Array(largeCount).keys()); _i2 < _arr2.length; _i2++) {
    var _elem = _arr2[_i2];
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./content":"content.ts","./clock":"clock.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
